                  ...
                  {!isSubmitted ? (
                      ...
                      <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        >
                          ...
                          <input
                            ...
                            required
                            className="w-full pl-12 pr-4 py-4 border-2 border-gray-200 dark:border-gray-600 rounded-xl focus:outline-none focus:border-convrt-purple transition-colors bg-gray-50/50 dark:bg-gray-700 text-gray-900 dark:text-white"
                          />
                        </motion.div>
                        ...
                        >
                          ...
                          <textarea
                            ...
                            required
                            rows={4}
                            className="w-full pl-12 pr-4 py-4 border-2 border-gray-200 dark:border-gray-600 rounded-xl focus:outline-none focus:border-convrt-purple transition-colors resize-none bg-gray-50/50 dark:bg-gray-700 text-gray-900 dark:text-white"
                          />
                        </motion.div>
                    ...
                    >
                      <motion.div
                        ...
                        className="w-20 h-20 mx-auto bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center mb-6 transition-colors duration-300"
                      >
