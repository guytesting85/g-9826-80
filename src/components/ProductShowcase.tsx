...
const ProductShowcase = () => {
  ...
  const tabs = [
    { id: 'insights', label: 'AI Insights', url: 'convrt.ai/insights' },
    { id: 'analytics', label: 'Analytics', url: 'convrt.ai/analytics' }
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-[20px] border border-white/60 dark:border-gray-600/60 shadow-lg p-6 transition-colors duration-300">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-[#F9F6F3] dark:bg-gray-700/50 rounded-lg border border-gray-100 dark:border-gray-600">
        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex flex-col justify-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed transition-colors duration-300">
                Track your outreach performance with detailed analytics and insights. Monitor engagement rates, response times, and conversion metrics.
              </p>
              <ul className="space-y-3">
                {[
            ...
            <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-[20px] border border-white/60 dark:border-gray-600/60 shadow-lg p-6 transition-colors duration-300">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-semibold text-convrt-dark-blue dark:text-white">Analytics Dashboard</h3>
              </div>
              
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-3 bg-[#F9F6F3] dark:bg-gray-700/50 rounded-lg border border-gray-100 dark:border-gray-600">
                    <div className="text-2xl font-bold text-[#6936F5]">85%</div>
                    <div className="text-xs text-gray-600 dark:text-gray-400">Response Rate</div>
                  </div>
                  <div className="p-3 bg-[#F9F6F3] dark:bg-gray-700/50 rounded-lg border border-gray-100 dark:border-gray-600">
                    <div className="text-2xl font-bold text-[#6936F5]">2.4x</div>
                    <div className="text-xs text-gray-600 dark:text-gray-400">Conversion Lift</div>
                  </div>
                </div>
                
                <div>
                  <h4 className="text-sm font-medium text-gray-800 dark:text-gray-200 mb-2">Top Performing Channels:</h4>
                  <ul className="space-y-2">
                    <li className="flex items-center justify-between">
                      <span className="text-sm text-gray-700 dark:text-gray-300">LinkedIn</span>
                      <span className="text-sm font-medium text-[#6936F5]">92%</span>
                    </li>
                    <li className="flex items-center justify-between">
                      <span className="text-sm text-gray-700 dark:text-gray-300">Email</span>
                      <span className="text-sm font-medium text-[#6936F5]">78%</span>
                    </li>
                    <li className="flex items-center justify-between">
                      <span className="text-sm text-gray-700 dark:text-gray-300">Twitter</span>
                      <span className="text-sm font-medium text-[#6936F5]">65%</span>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="container-section max-w-6xl mx-auto">
            ...
            >
              ...
              >
                <div className="px-8 py-6 border-b border-gray-200/70 dark:border-gray-700/70 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm transition-colors duration-300">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-sm text-gray-500 dark:text-gray-400 transition-colors duration-300">
                      {currentTab?.url || 'convrt.ai/insights'}
                    </div>
                  </div>
                    ...
                    {tabs.map((tab) => (
                      <button
                        ...
                        className={`px-4 py-2 rounded-md text-sm font-medium transition-all duration-200 ${
                          activeTab === tab.id
                            ? 'bg-white dark:bg-gray-800 text-convrt-purple shadow-sm'
                            : 'text-gray-600 dark:text-gray-300 hover:text-convrt-purple dark:hover:text-convrt-purple-light'
                        }`}
                      >
                        {tab.label}
                      </button>
                ...
                <div className={`p-8 bg-gradient-to-br from-gray-50/50 to-purple-50/50 dark:from-gray-800/50 dark:to-gray-700/50 transition-colors duration-300 ${
