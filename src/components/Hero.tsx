...
const Hero = () => {
  ...
  return <section className="relative min-h-screen pt-20 pb-5 overflow-hidden bg-[#F9F6F3]">
      <AnimatedBackground />
      ...
      <div className="container-section relative z-10">
        <motion.div initial="hidden" animate="visible" variants={containerVariants} className="max-w-6xl mx-auto text-center">
          ...
          <motion.div ref={demoRef} variants={itemVariants} className="mb-8 transform scale-105">
            <PlatformDemo />
          </motion.div>
