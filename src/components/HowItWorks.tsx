      ...
      <div className="container-section py-4">
        <div className="max-w-3xl mx-auto text-center mb-6">
          ...
          <motion.h2 
            ...
            className="heading-lg text-convrt-dark-blue dark:text-white mb-4 transition-colors duration-300"
          >
          ...
          <p className="text-convrt-dark-blue/80 dark:text-gray-300 text-lg max-w-2xl mx-auto mb-6 transition-colors duration-300">
          ...
          <div className="flex items-center justify-center space-x-4 mb-8">
            <button 
              onClick={prevStepSet}
              className="flex items-center px-4 py-2 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-900 dark:text-white rounded-lg transition-colors"
            >
        ...
        <motion.div 
          ...
          transition={{ duration: 0.5 }}
          className="max-w-6xl mx-auto bg-gray-100 dark:bg-gray-800 rounded-2xl overflow-hidden transition-colors duration-300"
        >
          <div className="flex flex-col lg:flex-row h-[700px]">
            {/* Steps Section */}
            <div className={`${
              currentSteps.steps.length === 4 ? 'lg:w-2/5' : 'lg:w-1/3'
            } flex flex-col gap-1 p-6 bg-gray-50 dark:bg-gray-700 overflow-y-auto transition-colors duration-300`}>
